...
// Genre: Electro/Garage Rock
// BPM: 110
// Key: A Major
// Source: github:eefano/strudel-songs-collection/humanperformance.js
// Garage rock with electronic elements and distorted guitar
...
const chseq = song.pick(["~","<B@2 F#m@2 E@2 D@2 D A@2>","<B@3>".struct("x*4"),
                         "<A@3 <F#m!2 E D B F#m E D>@9>*4".struct("x*4"),"<F#m@4>"])

const cs = zero(chseq).pick(["<[0,[~ 1@40],[~@2 2@40],[~@3 3@40]]@2>"])
...
stack(
  n(song.pick([cs,cs,cs,cs,cs])).chord(chseq).mode('above').anchor('e3')
    .voicing().mode("root").pickF(song,[cln,cln,cln,dst,cln]),

  n(song.pick(["~", "<~ 8 8 7 9 8 ~ ~ ~ 7 7 5 8 7 ~ ~ ~ 8 8 7 9 8 7 6 7 5 ~ 4 7 5 ~ ~ ~ 7 7 6 7 2@2 ~@5>*4",
               "<7@2 ~ [7 5] [9 7]@2 ~@100>*4",
  ...
  song.pick(["<~>","<rd*4,[bd sd]>","<rd*4,[sd bd]*2>",
