...
// BPM: 124.5
// Key: C Minor
// Source: github:eefano/strudel-songs-collection/pumpupthejam.js
// Classic house track with full arrangement
...
stack(
  ...
  ]).scale("c4:minor").note().clip(0.7).s("z_sawtooth").adsr("0.07:.1:0.6:0.1").gain(0.5),
  ...
  "<0@12 0 1 ~@2 3@8>".pick([
    ...
    .layer(x=>x.s("z_sawtooth").delay(0.6).dfb(0.5).dt(60/125*3/4).pan(0.55).gain(0.8),
           x=>x.s("z_square").lpf(300).lpe(2).lpa(-1.5).lpd(0.1).lpr(0.05).pan(0.45).gain(1)),

  "<0@4 [0,1]@12 [0,1,2]@4 [0,1,2,3]@4>".pick([
