...
// BPM: 115
// Key: C# Major
// Source: github:eefano/strudel-songs-collection/ventocaldo.js
// Italian disco house with organ, bass and full arrangement
...
stack(
  "<a@27 b@70 b@75 ~@56 b@70 b@75 ~@56 ~@87 ~@8>".pick({
  ...
  }).pick(["<0 4 7 8 10 11 9 12 14 12>*2"])
    .scale("c#4:major").note().s("gm_drawbar_organ:4").room(.3).lpf(1200).gain(0.7),

  "<a@172 b@56 a@145 b@56 c@87 ~@8>".pick({
  ...
  }).split([0,.6],s=>note(s[0]).clip(s[1])).lpf(400).gain(1.5),

  "<~@172 a@56 ~@145 a@56 b@87 ~@8>".pick({
    ...
    n(s[2].pick(["<0,1,2,3>/8","<[0,1,2,3]*3>/2"]))
  ...
  `<a@27 [a,b]@24 [a,b,c]@5 [a,d]@56 [a,d,e]@2 [a,d]@20 [a,d,f]@2 [a,d]@24 [a,d,g]@2 [a,d]@10
        ~@56 [a,d]@145 ~@56 h@87 ~@8>`.pick({
